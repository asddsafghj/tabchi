...
<b>]] .. tostring(links)..[[</b>
 😼 سازنده : 📡 @Russian_sales ]]
				...
				elseif text:match("^(لفت روبوتر)$") then
                                                          local list = redis:smembers("botBOT-IDsupergroups")
                                                          for i, v in pairs(list) do
                                                            rem(v)
                                                            tdcli_function ({
                                                          ...
                                                          local list2 = redis:smembers("botBOT-IDgroups")
                                                          for c, f in pairs(list2) do
                                                            rem(f)
                                                            tdcli_function ({
                                                                  ID = "ChangeChatMemberStatus",
                                                                  chat_id_ = f,
                                                          ...
                                                          return send(msg.chat_id_, msg.id_, "👉ChangeName👈👉ChangeUsername👈👉BOT-ID<i>از همه گروه ها و سوپر گروه ها خارج شدم</i>")
